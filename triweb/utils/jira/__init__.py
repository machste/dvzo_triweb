...
class Jira(object):
    ...
    def get_issues(self, list_name, max_age=None):
        ...
        issues = []
        path = f'/rest/api/3/search/jql?fields=issuetype,status,priority,summary,creator,assignee,created,duedate,resolutiondate,customfield_10058,customfield_10067,customfield_10069&jql=filter%3D{filter_id}'
